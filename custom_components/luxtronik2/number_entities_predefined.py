...
NUMBER_SENSORS: list[LuxtronikNumberDescription] = [
    ...
    # ),
    # LuxtronikNumberDescription(
    #     key=SensorKey.EFFICIENCY_PUMP_MINIMAL_VOLTAGE,
    #     luxtronik_key=LP.P0868_EFFICIENCY_PUMP_MINIMAL,
    #     translation_key_name=SensorKey.EFFICIENCY_PUMP_MINIMAL_VOLTAGE,
    #     device_class=NumberDeviceClass.VOLTAGE,
    #     native_unit_of_measurement=UnitOfElectricPotential.VOLT,
    #     native_min_value=1.1,
    #     native_max_value=10,
    #     native_step=0.1,
    #     factor=0.01,
    #     mode=NumberMode.BOX,
    ...
    # ),
    # LuxtronikNumberDescription(
    #     key=SensorKey.EFFICIENCY_PUMP_MINIMAL_PERCENTAGE,
    #     luxtronik_key=LP.P0868_EFFICIENCY_PUMP_MINIMAL,
    #     translation_key_name=SensorKey.EFFICIENCY_PUMP_MINIMAL_PERCENTAGE,
    #     device_class=NumberDeviceClass.SPEED,
    #     native_unit_of_measurement=PERCENTAGE,
    #     native_min_value=0,
    #     native_max_value=100,
    ...
    LuxtronikNumberDescription(
        key=SensorKey.EXTRA_DHW_TARGET_TEMPERATURE,
        luxtronik_key=LP.P1146_EXTRA_DHW_TARGET_TEMPERATURE,
        device_key=DeviceKey.domestic_water,
        device_class=NumberDeviceClass.TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        native_min_value=53.0,
        native_max_value=65.0,
        mode=NumberMode.BOX,
        native_step=0.5,
    ),
    LuxtronikNumberDescription(
        key=SensorKey.EXTRA_DHW_DURATION,
        luxtronik_key=LP.P1147_EXTRA_DHW_DURATION,
        device_key=DeviceKey.domestic_water,
        device_class=NumberDeviceClass.DURATION,
        native_unit_of_measurement=UnitOfTime.HOURS,
        native_min_value=2,
