...
NUMBER_SENSORS: list[LuxtronikNumberDescription] = [
    ...
    LuxtronikNumberDescription(
        ...
        luxtronik_key=LP.P0141_HEATING_CURVE_CIRCUIT2_END_TEMPERATURE,
        device_key=DeviceKey.heating,
        device_class=NumberDeviceClass.TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        native_min_value=20.0,
    ...
    LuxtronikNumberDescription(
        ...
        luxtronik_key=LP.P0142_HEATING_CURVE_CIRCUIT2_PARALLEL_SHIFT_TEMPERATURE,
        device_key=DeviceKey.heating,
        device_class=NumberDeviceClass.TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        native_min_value=5.0,
    ...
    LuxtronikNumberDescription(
        ...
        luxtronik_key=LP.P0143_HEATING_CURVE_CIRCUIT2_NIGHT_TEMPERATURE,
        device_key=DeviceKey.heating,
        device_class=NumberDeviceClass.TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        native_min_value=-15.0,
    ...
    LuxtronikNumberDescription(
        ...
        luxtronik_key=LP.P0774_HEATING_CURVE_CIRCUIT3_END_TEMPERATURE,
        device_key=DeviceKey.heating,
        device_class=NumberDeviceClass.TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        native_min_value=20.0,
    ...
    LuxtronikNumberDescription(
        ...
        luxtronik_key=LP.P0775_HEATING_CURVE_CIRCUIT3_PARALLEL_SHIFT_TEMPERATURE,
        device_key=DeviceKey.heating,
        device_class=NumberDeviceClass.TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        native_min_value=5.0,
    ...
    LuxtronikNumberDescription(
        ...
        luxtronik_key=LP.P0776_HEATING_CURVE_CIRCUIT3_NIGHT_TEMPERATURE,
        device_key=DeviceKey.heating,
        device_class=NumberDeviceClass.TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        native_min_value=-15.0,
    ...
    LuxtronikNumberDescription(
        ...
        luxtronik_key=LP.P0124_SOLAR_PUMP_OFF_MAX_DIFFERENCE_TEMPERATURE_BOILER,
        device_key=DeviceKey.domestic_water,
        device_class=NumberDeviceClass.TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        native_min_value=20,
    ...
    LuxtronikNumberDescription(
        ...
        native_min_value=18.0,  # fallback
        native_max_value=30.0,
        native_step=0.5,
        mode=NumberMode.BOX,
