...
class LuxtronikThermostat(ClimateEntity, RestoreEntity):
    ...
    def hvac_action(self):
        ...
        if self._is_heating_on():
            ...
            status in [LUX_STATUS_HEATING, LUX_STATUS_NO_REQUEST, LUX_STATUS_EVU]
            and self.__get_hvac_mode(CURRENT_HVAC_IDLE) != HVAC_MODE_OFF
        ):
    ...
    def __get_hvac_mode(self, hvac_action):
        ...
        if luxmode in [LuxMode.holidays,
            ...
            and hvac_action == CURRENT_HVAC_IDLE
        ):
            return self._attr_hvac_mode
