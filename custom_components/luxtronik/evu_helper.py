...
class LuxtronikEVUTracker:
    ...
    def update(self, current_value: str | None):
        ...
        if current_value == evu and str(self._last_state) != evu:
        ...
        elif current_value != evu and str(self._last_state) == evu:
            if self._should_use_first_slot(time_now):
    ...
    def _get_next_event_time(self, time_now: time) -> time:
        ...
        return min(future_events, default=min(candidates, key=lambda t: t != time.min))
